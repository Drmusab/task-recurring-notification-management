...
import * as pie from "@components/dashboard/pie";
import * as summary from "@components/dashboard/summary";
import * as month from "@components/dashboard/month";
import * as heatmap from "@components/dashboard/heatmap";
import * as bullet from "@components/dashboard/bullet";
