...
import type { ICalendarSource, IDayMetadata, IDot } from "@shared/utils/misc/daily-notes-compat";
import { getDailyNote, getWeeklyNote } from "@shared/utils/misc/daily-notes-compat";
import { get } from "svelte/store";

import { DEFAULT_WORDS_PER_DOT } from "src/constants";

import { dailyNotes, settings, weeklyNotes } from "@components/calendar/ui-calandar/stores";
import { clamp, getWordCount } from "@components/calendar/ui-calandar/utils";
