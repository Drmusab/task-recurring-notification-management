...
import { RemoveTaskDate, SetTaskDate } from "@components/shared/EditInstructions/DateInstructions";
import type { AllTaskDateFields } from "@shared/utils/dateTime/date-field-types";
import type { TaskSaver } from "@components/shared/Menus/TaskEditingMenu";
...
export function promptForDate(
    ...
    // TODO figure out how Today's date is determined: if  is left
