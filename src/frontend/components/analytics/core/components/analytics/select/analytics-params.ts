...
import { SelectXAxis } from "@components/analytics/core/components/analytics/select/select-x-axis";
import { SelectYAxis } from "@components/analytics/core/components/analytics/select/select-y-axis";
