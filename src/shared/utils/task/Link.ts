...
export class Link {
    ...
    /**
     * @param {Reference} rawLink - The raw link from 1 cache.
     ...
     *
     * So if this is used in a link in 1, 1 will use its own logic to open the
     * "closest" file.
     * 1 would choose the closest file to where the Tasks query is, as opposed
    ...
    /**
     * The actual full path that 1 would navigate to if the user clicked on the link,
