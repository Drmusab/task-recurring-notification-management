...
import { getSettings, getUserSelectedTaskFormat } from "@shared/config/Settings";
...
import { logging } from "@shared/utils/lib/logging";
import { logEndOfTaskEdit, logStartOfTaskEdit } from "@shared/utils/lib/LogTasksHelper";
import { DateFallback } from "@shared/utils/DateTime/DateFallback";
import { ListItem } from "@shared/utils/task/ListItem";
import type { Occurrence } from "@shared/utils/task/Occurrence";
import { Urgency } from "@shared/utils/task/Urgency";
import type { Recurrence } from "@shared/utils/task/Recurrence";
import type { TaskLocation } from "@shared/utils/task/TaskLocation";
import type { Priority } from "@shared/utils/task/Priority";
import { TaskRegularExpressions } from "@shared/utils/task/TaskRegularExpressions";
import { OnCompletion, handleOnCompletion } from "@shared/utils/task/OnCompletion";
...
export class Task extends ListItem {
    ...
    /**
     * Takes the given line from an 1 note and returns a Task object.
    ...
    public get priorityNameGroupText(): string {
        ...
        // The comments are hidden by 1 when the headings are rendered.
     ...
     * as opposed to tags recognised by 1, which does not treat numbers-only as valid tags.
     */
