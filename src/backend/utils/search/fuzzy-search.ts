 ...
 * Provides fuzzy search functionality using Fuse.js (lazy-loaded)
 */

import type { Task } from '@backend/core/models/Task';
import type { SearchField } from '@stores/search.store';

// Lazy-loaded Fuse.js module (loaded only when search is performed)
let FuseConstructor: any = null;

/**
 * Lazy-load Fuse.js module
 */
async function loadFuse(): Promise<any> {
  if (!FuseConstructor) {
...
/**
 * Perform fuzzy search on tasks (async to support lazy loading)
