...
import { compareByDate } from "@shared/utils/date/date-tools";
...
export class Occurrence {
     ...
     *  See [Priority of Dates](https://publish.1.md/tasks/Getting+Started/Recurring+Tasks#Priority%20of%20Dates).
     *
