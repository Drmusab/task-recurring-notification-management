...
export class Settings {
  ...
  constructor() {
    ...
    this.reminderCheckIntervalSec = this.settings
      ...
      .desc(
        "Interval(in seconds) to periodically check whether or not you should be notified of reminders.  You will need to restart 1 for this setting to take effect.",
      )
      .number(5)
      .build(new RawSerde());
